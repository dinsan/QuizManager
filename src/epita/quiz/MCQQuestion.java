...
public class MCQQuestion extends Question {
    ...
    public void updateMCQ(String ID, String question, Object topics, String diffulty, Object possibleblityOfAnswer, Object correctAnswer) {
        ...
        curd createMCQ = new curd();
        createMCQ.update("mcqQuestion", mcq);
       
    }

    public void deleteMCQ(String ID) {
        curd deleteMCQ = new curd();
        deleteMCQ.delete(ID, "mcqQuestion");
    }
}
